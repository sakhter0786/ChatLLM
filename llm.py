...
def export_chat_data(export_data: dict, export_format: str) -> Tuple[Any, str, str]:
    ...
    if fmt == "JSON":
        ...
        try:
            ...
            # Assuming 'st' is from Streamlit; adjust if this is not the case in your code
            print("Please install reportlab (`pip install reportlab`) to export as PDF.")
        ...
        doc.build(elements)  # Fixed: uses 'elements' instead of 'components'
        ...
        try:
            ...
            # Assuming 'st' is from Streamlit; adjust if this is not the case in your code
            print("Please install python-docx (`pip install python-docx`) to export as Word document.")
            return None, None, None
