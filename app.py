...
def export_chat_data(export_data: dict, export_format: str) -> Tuple[Any, str, str]:
    ...
    if fmt == "JSON":
        ...
        try:
            ...
            st.error("Please install reportlab (`pip install reportlab`) to export as PDF.")
        ...
        try:
            ...
            st.error("Please install python-docx (`pip install python-docx`) to export as Word document.")
            return None, None, None
        doc = Document()
...
<style>
.stApp {
    background-image: url('https://img.freepik.com/free-photo/3d-rendering-dark-earth-space_23-2151051365.jpg?t=st=1744639922~exp=1744643522~hmac=11aeb9f9db76028ba8504f06bbe1a0113192adf167635b0e484452fb1e1a79c7&w=826');
...
if prompt:
    ...
    try:
        ...
        # Calculate token count and append message
